...
<head>
    ...
    <style>
        .bg-login-image {
            ...
            /* จัดตำแหน่งตามแนวนอน */
            align-items: center;
            /* จัดตำแหน่งตามแนวตั้ง */

            /* ความสูงของพื้นที่หน้าเว็บ */
            background: url("Storage/images/logo_color.png") center center no-repeat;
            background-size: contain;
            /* หรือใช้ cover ตามความเหมาะสม */
        }
    </style>
</head>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="{{ route('registerUser.index') }}" method="post">
                                @csrf
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="username"
                                            placeholder="ตั้ง Username" name="username">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="name"
                                            name="name" placeholder="ชื่อผู้ใช้งานระบบ">
                                        <span class="text-danger">
                                            @error('name')
                                                {{ $message }}
                                            @enderror
                                ...
                                <div class="form-group">
                                    <input type="password" class="form-control form-control-user" id="password"
                                        placeholder="ตั้งรหัสผ่าน" name="password">
                                    <span class="text-danger">
                                        @error('password')
                                            {{ $message }}
                                        @enderror
