...
<body id="page-top">
        ...
        @section('content')
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">แก้ไขมูล สั่งผลิต</h1>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12">
                        <div class="card shadow mb-12">
                            ...
                            <div class="card-body">
                                <div class="">
                                    <form method="POST" enctype="multipart/form-data" action="/order_update">
                                        @csrf
                                        <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input class="form-control" list="kind_data" id="kind" name="kind"
                                                    placeholder="เลือกประเภท" value="{{ $data->K_N }}">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input class="form-control" list="screen_data" id="screen"
                                                    name="screen" placeholder="กรอกข้อมูล" value="{{ $data->screen }}">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input class="form-control" list="color_data" id="color"
                                                    name="color" placeholder="กรอกข้อมูล" value="{{ $data->color }}">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                @if ($data->img)
                                                    <img id="imagePreview2" src="{{ asset('public/'.$data->img) }}"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea class="form-control" id="note" name="note" rows="4">{{ $data->note }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                            ...
                                            <div class="form-group col-md-4">
                                                <input type="text" class="form-control" id="id" name="id"
                                                    placeholder="" value="{{ $data->id }}" hidden>
                                            </div>
                                            <div class="form-group col-md-4">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="FR_MK_05"
                                                    name="FR_MK_05" {{ $data && $data->mk05 ? 'checked' : '' }}>
                                        ...
                                        <button type="submit" value="บันทึก"
                                            class="btn btn-primary float-right">บันทึกข้อมูล</button>
                                    </form>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function previewImage(event) {
            ...
            if (imagePreview2) {
                // ถ้าตัวแปร imagePreview2 มีค่าไม่เป็น null
