        ...
        @section('content')
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">สรุปรายการทั้งหมด</h1>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; RKS {{ date('Y') }}</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
        ...
        var myLineChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    pointHitRadius: 10,
                    pointBorderWidth: 2,
                    data: [0, 10000, 5000, 10000, 10000, 20000, 15000, 25000, 20000, 30000, 25000, 30000],
                }],
            },
            options: {
