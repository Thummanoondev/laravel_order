    ...
    <div id="wrapper">
        ...
        @section('content')
            ...
            <div class="container-fluid">
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">FR MK 02</h1>
                <p class="mb-4">เอกสารใบสั่งผลิตสินค้า FR MK 02 </p>
                <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">รายการเอกสาร FR_MK_02</h6>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-bordered data-table" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:20% ;width: 100px; text-align: center;">FR_MK_02</th>
                                        <th style="width:10%">พิมพ์สติ๊กเกอร์</th>
                                        <th style="width:10%">ลำดับรายการ</th>
                                ...
                                <tfoot>
                                    <tr>
                                        <th>ลำดับรายการ</th>
                                        <th>FR_MK_02</th>
                                        <th style="width:20%">พิมพ์สติ๊กเกอร์</th>
                                        <th style="width:10%">ลำดับรายการ</th>
                                        <th style="width:10%">รายละเอียด</th>
                                        <th style="width:10%">ชื่อลูกค้า</th>
                                        <th style="width:10%">รหัสแบบ</th>
    ...
    <script>
        $(function() {
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('doc02.index') }}", // URL ของเราที่เรากำหนดใน Controller Laravel
                columns: [{
                        data: 'No',
                        name: 'No'
